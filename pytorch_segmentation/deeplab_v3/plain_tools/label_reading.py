...
def main():
    ...
    label = read_SYNTHIA_label(r'E:\RCNN\deep-learning-for-image-processing-master\pytorch_segmentation\deeplab_v3\0000000.png', SYNTHIA_label_map, image_size)
    label_ori = read_SYNTHIA_label_ori(r'E:\RCNN\deep-learning-for-image-processing-master\pytorch_segmentation\deeplab_v3\0000000.png', SYNTHIA_label_map, image_size)
    print(label)
    print(label_ori)
